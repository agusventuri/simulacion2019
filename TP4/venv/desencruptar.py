...
class Plugboard:
    ...
    def __init__(self, mapping):
        """ mapping = [("A", "B"), ("C", "D")] """
        self.base = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
        self.mapper = "CDEFGHIJKLMNOPQRSTUVWXYZAB"
        self.mapping = {}

        for i in range(len(self.base)):
            self.mapping[self.base[i]] = self.mapper[i]
...
def main():
    ...
    try:
        ...
        ciphertext = "wr zepmhexi ymj eqttgev cpuygt dtz mfaj wr jr wr zshzo gpkioc zshzo oguucig zshzo ywqhbelbwvlhkcgy fsi dtz hfs yjqq ymj wjxy ri ymj yjfr ymfy dtz bts ymj gleppirki"
